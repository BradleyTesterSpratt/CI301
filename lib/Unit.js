...
Unit.prototype.move = function() {
  ...
  for (i=0; movementAllowence > i; i++) {
    ...
    // this.position.x = this.position.x + Math.sign(this.destination.x - this.position.x);
    // this.position.y = this.position.y + Math.sign(this.destination.y - this.position.y);
  }
